...
<head>
    ...
    <link href="view/PAGINA_WEB/css/bootstrap.min.css" rel="stylesheet">
    <link href="view/PAGINA_WEB/css/font-awesome.min.css" rel="stylesheet">
    <link href="view/PAGINA_WEB/css/animate.min.css" rel="stylesheet">
    <link href="view/PAGINA_WEB/css/owl.carousel.css" rel="stylesheet">
    <link href="view/PAGINA_WEB/css/owl.transitions.css" rel="stylesheet">
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="view/PAGINA_WEB/images/logo.png" alt="logo"></a>
                </div>
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(view/PAGINA_WEB/images/slider/bg1.jpg);">
             ...
             <div class="item" style="background-image: url(view/PAGINA_WEB/images/slider/bg2.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="view/PAGINA_WEB/images/main-feature.png" alt="">
                </div>
                <div class="col-sm-6">
            ...
            <div class="portfolio-items">
                <div class="portfolio-item filter1">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/01.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Nemo enim ipsam</h3>
                            Voluptatem quia voluptas
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/01.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item filter2 filter3">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/02.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Sed quia consequ</h3>
                            Magni dolores eos qui
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/02.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item filter1">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/03.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Neque porro</h3>
                            Qui dolorem ipsum quia
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/03.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item filter2">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/04.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Sed quia non numquam</h3>
                            Eius modi tempora incidunt
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/04.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item filter1 filter3">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/05.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Labore et dolore</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/05.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item filter2">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/06.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Quis autem vel</h3>
                            Ut enim ad minima veniam
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/06.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item filter1 filter3">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/07.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Quis nostrum</h3>
                            Exercitationem ullam
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/07.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item filter2">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="view/PAGINA_WEB/images/portfolio/08.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Corporis suscipit</h3>
                            Nisi ut aliquid ex ea
                            <a class="preview" href="view/PAGINA_WEB/images/portfolio/08.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="team-img">
                            <img class="img-responsive img-circle" src="view/PAGINA_WEB/images/team/01.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Jane Dohan</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="team-img">
                            <img class="img-responsive img-circle" src="view/PAGINA_WEB/images/team/02.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Leny Fuston</h3>
                            <span>Accounter</span>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="team-img">
                            <img class="img-responsive img-circle" src="view/PAGINA_WEB/images/team/03.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Sander Bell</h3>
                            <span>Designer</span>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        <div class="team-img">
                            <img class="img-responsive img-circle" src="view/PAGINA_WEB/images/team/04.jpg" alt="">
                        </div>
                        <div class="team-info">
                    ...
                    <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <p><img class="img-circle img-thumbnail" src="view/PAGINA_WEB/images/testimonial/01.jpg" alt=""></p>
                            ...
                            <div class="item">
                                <p><img class="img-circle img-thumbnail" src="view/PAGINA_WEB/images/testimonial/02.jpg" alt=""></p>
    ...
    <script src="view/PAGINA_WEB/js/mousescroll.js"></script>
    <script src="view/PAGINA_WEB/js/smoothscroll.js"></script>
    <script src="view/PAGINA_WEB/js/jquery.prettyPhoto.js"></script>
    <script src="view/PAGINA_WEB/js/jquery.isotope.min.js"></script>
